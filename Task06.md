...
[![img](https://github.com/2209520576/CV-Image-Processing/raw/master/IMG/edge1.jpg)](https://github.com/2209520576/CV-Image-Processing/blob/master/IMG/edge1.jpg)
...
其中$ \mathbf {I}$表示原图片，$\mathbf {G}'*{x}$和$\mathbf {G}'*{y}$分别表示沿图片水平和竖直方向上的变化，$ * $表示卷积操作
...
【例2】下面一个5×5高斯卷积核例子，用于创建相邻图像，$\sigma = 1.4$。 （*表示卷积运算。） $$ \mathbf {B} ={\frac {1}{159}}{\begin{bmatrix}2&4&5&4&2\4&9&12&9&4\5&12&15&12&5\4&9&12&9&4\2&4&5&4&2\end{bmatrix}}*\mathbf {A} $$ 注意，选择高斯核的大小会影响检测器的性能。 尺寸越大，检测器对噪声的灵敏度越低。 此外，随着高斯滤波器核大小的增加，用于检测边缘的定位误差将略有增加。一般5x5是一个比较不错的trade off。

#### 2.计算梯度强度和方向

进行高斯滤波后，图像中的边缘可以指向各个方向，接下来使用四个算子来检测图像中的水平、垂直和对角边缘。边缘检测的算子（如Roberts，Prewitt，Sobel等）返回水平$G_x$和垂直$G_y$方向的一阶导数值，由此便可以确定像素点的梯度$G$和方向$\theta$ 。 $$ \mathbf {G} ={\sqrt {{\mathbf {G} _{x}}^{2}+{\mathbf {G} _{y}}^{2}}} \tag{1} $$
...
[![img](https://github.com/2209520576/CV-Image-Processing/raw/master/IMG/angle.png)](https://github.com/2209520576/CV-Image-Processing/blob/master/IMG/angle.png)
...
[![img](https://github.com/2209520576/CV-Image-Processing/raw/master/IMG/doubleThreshold.png)](https://github.com/2209520576/CV-Image-Processing/blob/master/IMG/doubleThreshold.png)
...
[![img](https://github.com/2209520576/CV-Image-Processing/raw/master/IMG/sobel_result.png)](https://github.com/2209520576/CV-Image-Processing/blob/master/IMG/sobel_result.png)
...
[![img](https://github.com/2209520576/CV-Image-Processing/raw/master/IMG/canny_result.png)](https://github.com/2209520576/CV-Image-Processing/blob/master/IMG/canny_result.png)
